...
@interface SCTemplateMallButton () <UIViewControllerTransitioningDelegate>
...
@implementation SCTemplateMallButton
...
- (void)setupSubviews {
    ...
    [self whenTapped:^{
        ...
        SQNavigationController * navigationController = [[SQNavigationController alloc]initWithRootViewController:[SCTemplateMallDownloadViewController new]];
