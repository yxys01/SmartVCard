...
#import "SCCardContactViewController.h"
#import "ContactModel.h"
#import "ContactDataHelper.h"
#import "SCCardContactTableViewCell.h"

@interface SCCardContactViewController()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UISearchDisplayDelegate>
{
    NSArray *_rowArr;
    NSArray *_sectionArr;
}
...
@implementation SCCardContactViewController{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SCCardContactTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:cellIde];
    if (cell==nil) {
        cell=[[SCCardContactTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIde];
    }
