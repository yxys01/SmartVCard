...
#import "SCMyCodeViewController.h"

static const CGFloat kBorderW = 100;
static const CGFloat kMargin = 30;
@interface Scan_Card ()<UIAlertViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>{
...
-(void)myCode{
    ...
    NSLog(@"我的二维码");
    SCMyCodeViewController*vc=[[SCMyCodeViewController alloc]init];
