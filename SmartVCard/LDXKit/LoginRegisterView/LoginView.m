...
{
    // 判断注册页面控件里是否都有值
    if ([_regist.nameTextF.text isEqualToString:@""] || [_regist.passTextF.text isEqualToString:@""] || [_regist.ageTextF.text isEqualToString:@""] || [_regist.telephoneF.text isEqualToString:@""]) {
    ...
    // 返回注册的信息
    [self.delegate getRegisterName:_regist.nameTextF.text pass:_regist.passTextF.text age:_regist.ageTextF.text telephone:_regist.telephoneF.text image:self.regist.headerImageButton.imageView.image];
}
